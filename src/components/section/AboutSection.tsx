...
const AboutSection = () => {
  return (
    <>
      <section
        id="about"
        className="container relative mx-auto overflow-hidden bg-gray-100"
      >
          ...
          >
            <div className="w-full p-3">
              <h1 className="text-3xl font-normal text-accent-100 font-bigtittle">
                ...
                <span className="font-travelyouu">TravelYouuu</span>
              </h1>
              <h1 className="text-6xl font-bold text-white font-bigtittle">
                About Us
              </h1>
              <p className="font-sans text-justify text-white">
                At <span className="font-travelyouu">TravelYouuu</span>, we’re
                dedicated to curating travel experiences that immerse you in the
                rich arts and vibrant cultures of destinations around the globe.
                From exploring the ancient temples of Asia to experiencing the
                lively art scenes of Europe and Africa’s captivating traditions,
                each tour is designed to bring you closer to the heart of every
                country’s heritage.
                <br />
                <br />
                Whether you’re a history buff, an art enthusiast, or simply
                curious about new cultures, our tours offer unique, authentic
                encounters that leave a lasting impact. Don’t miss the chance to
                embark on a journey that’s more than sightseeing—it’s a cultural
                immersion.
                <br />
                <br />
                Book now and enjoy a 15% discount on purchases from our partners
                for the first 50 travelers!
              </p>
            </div>
